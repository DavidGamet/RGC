...
class OccassionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occassion" do
    assert_difference('Occassion.count') do
      post occassions_url, params: { occassion: { description: @occassion.description, name: @occassion.name, photo: @occassion.photo, prix: @occassion.prix, user_id: @occassion.user_id } }
    end
  ...
  test "should update occassion" do
    patch occassion_url(@occassion), params: { occassion: { description: @occassion.description, name: @occassion.name, photo: @occassion.photo, prix: @occassion.prix, user_id: @occassion.user_id } }
