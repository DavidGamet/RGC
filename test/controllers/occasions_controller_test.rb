...
class OccasionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occasion" do
    assert_difference('Occasion.count') do
      post occasions_url, params: { occasion: { description: @occasion.description, name: @occasion.name, photo: @occasion.photo, prix: @occasion.prix, user_id: @occasion.user_id } }
    end
  ...
  test "should update occasion" do
    patch occasion_url(@occasion), params: { occasion: { description: @occasion.description, name: @occasion.name, photo: @occasion.photo, prix: @occasion.prix, user_id: @occasion.user_id } }
